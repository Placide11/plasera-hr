...
import { db } from "@/db";
import { activities, departments, employees, leaveRequests, users } from "@/db/schema";

// Temporary one-time seed endpoint.
// Protected by SEED_SECRET so it can't be triggered by anyone else.
// Delete this file (and the SEED_SECRET env var) once you've seeded production.
